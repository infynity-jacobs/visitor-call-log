          ...
          <div className="form-grid">
            ...
            {purpose === 'Bill Pay' && (
              <div>
                ...
                <input id="purposeDetails" required value={form.purposeDetails} onChange={(e) => update('purposeDetails', e.target.value)} />
              </div>
            )}
            ...
            {purpose === 'Enquiry' && (
              <>
                ...
                <div>
                  ...
                  <input id="enquiryDetails" required value={form.enquiryDetails} onChange={(e) => update('enquiryDetails', e.target.value)} />
                </div>
              </>
            )}
            ...
            {purpose === 'Complaint' && (
              <div>
                ...
                <input id="complaintDetails" required value={form.complaintDetails} onChange={(e) => update('complaintDetails', e.target.value)} />
              </div>
            )}
            ...
            {purpose === 'Purchase' && (
              <div>
                ...
                <input id="purchaseDetails" required value={form.purchaseDetails} onChange={(e) => update('purchaseDetails', e.target.value)} />
              </div>
            )}
              ...
              <>
                ...
                {form.personToVisit === 'Others' && (
                  <div>
                    ...
                    <input id="personToVisitOther" required value={form.personToVisitOther} onChange={(e) => update('personToVisitOther', e.target.value)} />
                  </div>
                )}
              </>
            )}
            ...
            {purpose === 'Interview' && (
              <div>
                ...
                <input id="interviewDetails" required value={form.interviewDetails} onChange={(e) => update('interviewDetails', e.target.value)} />
              </div>
            )}
            ...
            {purpose === 'Donation' && (
              <div>
                ...
                <input id="donationDetails" required value={form.donationDetails} onChange={(e) => update('donationDetails', e.target.value)} />
              </div>
            )}
            ...
            {purpose === 'Other' && (
              <div>
                ...
                <input id="otherDetails" required value={form.otherDetails} onChange={(e) => update('otherDetails', e.target.value)} />
              </div>
            )}
          </div>
